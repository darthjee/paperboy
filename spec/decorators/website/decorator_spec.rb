...
describe Website::Decorator do
  ...
  describe '#to_json' do
    ...
    context 'when object is a collection' do
      let(:object) { build_list(:website, 3) }
      ...
      context 'when object is a collection of invalid not validated objects' do
        let(:object) { build_list(:website, 3, name: nil) }
